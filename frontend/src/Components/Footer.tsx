        ...
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
              ...
              <div className="flex sm:justify-center sm:mt-0 mt-4">
              <a
                href="#"
              ...
              <a
                href="#"
                className="text-gray-800 hover:text-orange-600 ms-5"
              >
                <svg
                  className="w-4 h-4"
                  aria-hidden="true"
            ...
            <div className="grid grid-cols-4 gap-4 sm:gap-4 sm:grid-cols-3">
              <div>
                ...
                <ul className="text-gray-800 font-medium text-sm">
                  ...
                  <li className="mb-2 hover:text-orange-500">
                    <Link to={"/"}>Premium Nut Butters</Link>
                  </li>
                  <li className="mb-2 hover:text-orange-500">
                    <Link to={"/"}>All Natural & Organic</Link>
                  </li>
                  <li className="mb-2 hover:text-orange-500">
                    <Link to={"/"}>Wholegrain Rice Cakes</Link>
                  </li>
                </ul>
              </div>
              <div>
              ...
              <div>
                ...
                <ul className="text-gray-500 dark:text-gray-400 font-medium w-60">
                  <li className="mb-4 ">
                    <Input placeholder="Email *" className="mb-4" />
                    <Button className="w-full " backgroundColor={"black"} color={"white"} _hover={{
                        bgColor: "#dd6b20"
                    }}>Sign Up</Button>
                  </li>
